...
if page == "Home":
    ...
    # Student Details
    name = st.text_input("Name:", "CIMANUKA B.M.")
    ...
    try:
        ...
        st.download_button(label="📄 Download CIMANUKA_CV", data=resume_bytes, file_name="CIMANUKA_CV.pdf", mime="application/pdf")
    except FileNotFoundError:
        st.error("❌ Resume file not found!")

    st.markdown("---")
    st.subheader("About Me")
    about_me = st.text_area("I am passionate about technology and software development, with hands-on experience in building projects and solving real-world problems.")
    st.write(about_me)
...
# Projects Section
    ...
    with st.expander("📊 Student Career Guidance System"):
...
# Settings Section
    ...
    name = st.text_input("Your Name", "CIMANUKA B.M.")
...
# Contact Section
    ...
    st.write("📧 Email: ug2323269.ac.rw")
    st.write("[🔗 LinkedIn](https://www.linkedin.com/in/exaucia-kim-9b996029a/e)")
    st.write("[📂 GitHub](https://github.com/Mona0009w)")
